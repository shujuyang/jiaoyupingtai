...
<head>
    ...
    <link rel="stylesheet" href="/home/css/page-learing-forget-password.css" />
</head>
...
<body>
                    ...
                    <ul class="r-position">
                        ...
                        <li>
                            <div class="form-group verif">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="phone" placeholder="请输入验证码">
                                    <a href="javascript:;"><img src="/home/img/page-verif.png" alt="验证码" width="66" height="34"></a>
                                    <span class="verif-span">请输入5-25个字符</span>
                                </div>
                            </div>
                        </li>
    ...
    <script src="/home/js/page-learning-forget-password.js"></script>
</body>